...
class Password(Object):
    ...
    def read(b: BytesIO, *args) -> "Password":
        ...
        return Password(new_algo, new_secure_algo, secure_random, has_recovery, has_secure_values, has_password, current_algo, srp_B, srp_id, hint, email_unconfirmed_pattern)
